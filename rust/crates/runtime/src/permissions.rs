...
impl PermissionPolicy {
    ...
    pub fn authorize_with_capabilities(
        ...
        self.authorize_with_capabilities_and_context(tool_name, input, &PermissionContext::default(), prompter, capability_registry)
    }

    #[must_use]
    pub fn authorize_with_capabilities_and_context(
        &self,
        tool_name: &str,
        input: &str,
        ...
        self.authorize_with_context(tool_name, input, context, prompter)
    }
    ...
    pub fn new(active_mode: PermissionMode) -> Self {
        Self {
            ...
            tool_capabilities: {
                ...
                caps.insert("bash".to_string(), Capability::ExecuteCommands);
                caps.insert("read_file".to_string(), Capability::ReadFiles);
                caps.insert("write_file".to_string(), Capability::WriteFiles);
                caps.insert("edit_file".to_string(), Capability::WriteFiles);
                caps.insert("glob_search".to_string(), Capability::ReadFiles);
                caps.insert("grep_search".to_string(), Capability::ReadFiles);
                caps.insert("WebFetch".to_string(), Capability::WebFetch);
                caps.insert("WebSearch".to_string(), Capability::WebFetch);
                caps
            },
        }
    }
...
mod tests {
    ...
    #[test]
    fn honors_fine_grained_capabilities() {

...
use crate::providers::claw_provider::{self, ClawApiClient};
...
impl ProviderClient {
    ...
    pub fn from_model_with_anthropic_auth(
        ...
        match providers::detect_provider_kind(&resolved_model) {
            ...
            ProviderKind::ClawApi => {
                Ok(Self::ClawApi(ClawApiClient::from_env()?))
            },
    ...
    pub fn prompt_cache_stats(&self) -> Option<PromptCacheStats> {
        match self {
            ...
            Self::ClawApi(_) | Self::Xai(_) | Self::OpenAi(_) => None,
        }
    }
    ...
    pub async fn send_message(
        ...
        match self {
            ...
            Self::ClawApi(client) => client.send_message(request).await,
